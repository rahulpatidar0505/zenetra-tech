...
@Component({
  selector: 'app-zenetra-banner-slider',
  templateUrl: './zenetra-banner-slider.component.html',
  styleUrls: ['./zenetra-banner-slider.component.scss'],
  imports: [ImagePreloadDirective],
  standalone: true
})
export class ZenetraBannerSliderComponent implements OnInit, OnDestroy {
